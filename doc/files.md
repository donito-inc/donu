...
* donu.conf: contains configuration settings for donud or donu-qt
* donud.pid: stores the process id of donud while running
...
* debug.log: contains debug information and general logging generated by donud or donu-qt

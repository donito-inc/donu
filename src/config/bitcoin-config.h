...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Donu developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Donu"

/* Copyright year */
#define COPYRIGHT_YEAR 2020

/* Donu version Build */
#define DONU_VERSION_BUILD 0

/* Donu major version */
#define DONU_VERSION_MAJOR 1

/* Donu minor version */
#define DONU_VERSION_MINOR 0

/* Donu build revision */
#define DONU_VERSION_REVISION 3

/* Define to 1 to enable sync checkpoints */
...
#define PACKAGE_BUGREPORT "https://github.com/donu/donu/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Donu"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Donu 1.0.3"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "donu"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://donu.net/"

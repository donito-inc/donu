 ...
 */
static const int64_t MAX_FUTURE_BLOCK_TIME = 5 * 60 * 60;
...
// donu
    // donu: money supply related block index fields
    int64_t nMint;
    int64_t nMoneySupply;

    // donu: proof-of-stake related block index fields
    unsigned int nFlags;  // donu: block index flags
    enum
    {

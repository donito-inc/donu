...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help") || gArgs.IsArgSet("-version"))
    {
        ...
        std::string strUsage = strprintf(_("%s donu-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  donu-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded donu transaction") + "\n" +
              "  donu-tx [options] -create [commands]   " + _("Create hex-encoded donu transaction") + "\n" +
              "\n";

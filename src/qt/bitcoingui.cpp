    ...
    platformStyle(_platformStyle)
{
    ...
    QFontDatabase::addApplicationFont(":/fonts/sf-pro-regular");
...
void BitcoinGUI::createActions()
{
    ...
    mintingAction = new QAction(this);
...
//    connect(multisigAction, SIGNAL(triggered()), this, SLOT(gotoMultisigPage()));
    ...
    signMessageAction = new QAction(QIcon(":/icons/editpaste"), tr("Sign &message..."), this);
    ...
    openChatroomAction = new QAction(QIcon(":/icons/donu"), tr("&Discord"), this);
    openChatroomAction->setStatusTip(tr("Open the Donu Discord in a web browser."));

    openForumAction = new QAction(QIcon(":/icons/donu"), tr("&Reddit"), this);
    openForumAction->setStatusTip(tr("Open https://www.reddit.com/r/Donito/ in a web browser."));
...
void BitcoinGUI::createToolBars()
{
    if(walletFrame)
    {
        ...
        toolbar->widgetForAction(mintingAction)->setObjectName("mintingButton");
...
void BitcoinGUI::openChatroom() {
    QDesktopServices::openUrl(QUrl("https://donu.io/discord"));
}

void BitcoinGUI::openForum() {
    QDesktopServices::openUrl(QUrl("https://www.reddit.com/r/Donito/"));
}
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        tooltip = tr("%n active connection(s) to Donu network", "", count);
	if (count > 0) {
	  tooltip += QString(".<br>") + tr("Click to disable network activity.");
	}
    } else {
...
void BitcoinGUI::setNumBlocks(int count, const QDateTime& blockDate, double nVerificationProgress, bool header)
{
    ...
    else
    {
        ...
        if(count == 0) {
          labelBlocksIcon->setPixmap(QIcon(QString(":/icons/warning").arg(spinnerFrame, 3, 10, QChar('0')))

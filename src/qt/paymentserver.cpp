...
const char* BIP71_MIMETYPE_PAYMENT = "application/donu-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/donu-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/donu-paymentrequest";
...
void PaymentServer::handleURIOrFile(const QString& s)
{
    ...
    if (s.startsWith(BITCOIN_IPC_PREFIX, Qt::CaseInsensitive)) // donu: URI
    {
#if QT_VERSION < 0x050000
        QUrl uri(s);
#else
